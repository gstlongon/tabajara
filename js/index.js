class Index {
    ...
    async displayItems() {
        ...
        itemsContainer.innerHTML = ''; // Limpa o conteúdo anterior antes de adicionar os novos itens
    
        fetchedItems.forEach((item, index) => {
            // Criar um novo elemento para cada item
            let itemElement = document.createElement('div');
            itemElement.classList.add('index__item'); // Adicione a classe do seu item
    
            // Adicionar conteúdo ao elemento
            itemElement.innerHTML = `
                <div class="index__item--img"><img src="img/${item.foto}" alt=""></div>
            ...
            cartItem.innerHTML = `
                <div class="card__item">
                    <div class="card__photo">
                        <img class="card__img" src="img/${item.foto}" alt="${item.nome}">
                    </div>
